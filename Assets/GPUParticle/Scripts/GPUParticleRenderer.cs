...
public class GPUParticleRendererBase : MonoBehaviour
{
...
public class GPUParticleRenderer : GPUParticleRendererBase
{
    ...
    void Reset()
    {
        m_mesh = AssetDatabase.LoadAssetAtPath("Assets/DeferredShading/Mesh/cube.asset", typeof(Mesh)) as Mesh;
